...
namespace AIMuseVendor\Doctrine\Deprecations;
 ...
 *    \AIMuseVendor\Doctrine\Deprecations\Deprecation::enableTrackingDeprecations();
 *
 *  - Uses @trigger_error with E_USER_DEPRECATED
 *    \AIMuseVendor\Doctrine\Deprecations\Deprecation::enableWithTriggerError();
 *
 *  - Sends deprecation messages via a PSR-3 logger
 *    \AIMuseVendor\Doctrine\Deprecations\Deprecation::enableWithPsrLogger($logger);
 *
