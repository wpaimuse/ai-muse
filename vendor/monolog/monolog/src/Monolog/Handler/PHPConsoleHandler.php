 ...
 *
 *      $logger = new \AIMuseVendor\Monolog\Logger('all', array(new \AIMuseVendor\Monolog\Handler\PHPConsoleHandler()));
 *      \AIMuseVendor\Monolog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    /**
     * @param  array<string, mixed> $options   See \AIMuseVendor\Monolog\Handler\PHPConsoleHandler::$options for more details
