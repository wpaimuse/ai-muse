...
use AIMuseVendor\Carbon\Exceptions\BadFluentConstructorException;
use AIMuseVendor\Carbon\Exceptions\BadFluentSetterException;
use AIMuseVendor\Carbon\Exceptions\InvalidCastException;
use AIMuseVendor\Carbon\Exceptions\InvalidIntervalException;
use AIMuseVendor\Carbon\Exceptions\OutOfRangeException;
use AIMuseVendor\Carbon\Exceptions\ParseErrorException;
use AIMuseVendor\Carbon\Exceptions\UnitNotConfiguredException;
...
use AIMuseVendor\Carbon\Traits\IntervalStep;
use AIMuseVendor\Carbon\Traits\MagicParameter;
...
class CarbonInterval extends DateInterval implements CarbonConverterInterface
{
     ...
     *
     * @var \AIMuseVendor\Symfony\Component\Translation\TranslatorInterface
     */
     ...
     *
     * @throws \AIMuseVendor\Carbon\Exceptions\ParseErrorException when the $interval cannot be parsed as an interval.
     *
     * @return static
     */
    ...
    public function forHumans($syntax = null, $short = false, $parts = -1, $options = null)
    {
        ...
        /** @var \AIMuseVendor\Symfony\Component\Translation\Translator $translator */
