...
use AIMuseVendor\Illuminate\Contracts\Queue\Queue;
use AIMuseVendor\Illuminate\Contracts\Queue\ShouldQueue;
use Illuminate\Foundation\Bus\PendingChain;
use AIMuseVendor\Illuminate\Pipeline\Pipeline;
...
class Dispatcher implements QueueingDispatcher
{
     ...
     *
     * @var \AIMuseVendor\Illuminate\Pipeline\Pipeline
     */
    protected $pipeline;
     ...
     *
     * @param  \AIMuseVendor\Illuminate\Support\Collection|array|mixed  $jobs
     ...
     *
     * @param  \AIMuseVendor\Illuminate\Contracts\Queue\Queue  $queue
     * @param  mixed  $command
     * @return mixed
     */
