...
namespace AIMuseVendor\Illuminate\Session\Middleware;

use Closure;
use AIMuseVendor\Illuminate\Contracts\Session\Session;
use AIMuseVendor\Illuminate\Http\Request;
use Illuminate\Routing\Route;
use AIMuseVendor\Illuminate\Session\SessionManager;
...
class StartSession
{
     ...
     * The session manager.
     *
     * @var \AIMuseVendor\Illuminate\Session\SessionManager
     */
    protected $manager;
     ...
     *
     * @param  \AIMuseVendor\Illuminate\Session\SessionManager  $manager
     ...
     * @param  \AIMuseVendor\Illuminate\Http\Request  $request
     * @param  \AIMuseVendor\Illuminate\Contracts\Session\Session  $session
     * @return \AIMuseVendor\Illuminate\Contracts\Session\Session
     */
