...
use Closure;
use AIMuseVendor\Illuminate\Contracts\Mail\Factory;
use AIMuseVendor\Illuminate\Contracts\Mail\Mailable;
use AIMuseVendor\Illuminate\Contracts\Mail\Mailer;
use AIMuseVendor\Illuminate\Contracts\Mail\MailQueue;
...
class MailFake implements Factory, Mailer, MailQueue
{
     ...
     *
     * @param  \AIMuseVendor\Illuminate\Contracts\Mail\Mailable|string|array  $view
     * @param  array  $data
