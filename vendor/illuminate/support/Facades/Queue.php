...
use AIMuseVendor\Illuminate\Support\Testing\Fakes\QueueFake;

/**
 * @method static \AIMuseVendor\Illuminate\Contracts\Queue\Job|null pop(string $queue = null)
 * @method static \AIMuseVendor\Illuminate\Contracts\Queue\Queue setConnectionName(string $name)
...
class Queue extends Facade
{
     ...
     *
     * @return \AIMuseVendor\Illuminate\Support\Testing\Fakes\QueueFake
     */
