 ...
 * @method static \Illuminate\Routing\Route substituteBindings(\AIMuseVendor\Illuminate\Support\Facades\Route $route)
 ...
 * @method static void substituteImplicitBindings(\AIMuseVendor\Illuminate\Support\Facades\Route $route)
