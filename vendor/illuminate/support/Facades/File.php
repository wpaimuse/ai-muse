...
/**
 * @method static \AIMuseVendor\Symfony\Component\Finder\SplFileInfo[] allFiles(string $directory, bool $hidden = false)
 * @method static \AIMuseVendor\Symfony\Component\Finder\SplFileInfo[] files(string $directory, bool $hidden = false)
 ...
 * @method static \AIMuseVendor\Illuminate\Support\LazyCollection lines(string $path)
 * @method static void relativeLink(string $target, string $link)
 * @method static void replace(string $path, string $content)
 *
 * @see \AIMuseVendor\Illuminate\Filesystem\Filesystem
 */
