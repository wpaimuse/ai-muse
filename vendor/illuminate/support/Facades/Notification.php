...
use AIMuseVendor\Illuminate\Support\Testing\Fakes\NotificationFake;

/**
 * @method static \Illuminate\Notifications\ChannelManager locale(string|null $locale)
 * @method static \AIMuseVendor\Illuminate\Support\Collection sent(mixed $notifiable, string $notification, callable $callback = null)
 ...
 * @method static void send(\AIMuseVendor\Illuminate\Support\Collection|array|mixed $notifiables, $notification)
 * @method static void sendNow(\AIMuseVendor\Illuminate\Support\Collection|array|mixed $notifiables, $notification)
 *
...
class Notification extends Facade
{
     ...
     *
     * @return \AIMuseVendor\Illuminate\Support\Testing\Fakes\NotificationFake
     */
