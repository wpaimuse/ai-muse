...
use AIMuseVendor\Illuminate\Database\Schema\Grammars\Grammar;
use AIMuseVendor\Illuminate\Database\SQLiteConnection;
use AIMuseVendor\Illuminate\Support\Fluent;
...
class Blueprint
{
     ...
     *
     * @var \AIMuseVendor\Illuminate\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @var \AIMuseVendor\Illuminate\Support\Fluent[]
     */
    protected $commands = [];
     ...
     *
     * @return \AIMuseVendor\Illuminate\Support\Fluent
     */
     ...
     *
     * @param  string  $column
     * @return \AIMuseVendor\Illuminate\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \AIMuseVendor\Illuminate\Database\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param  \AIMuseVendor\Illuminate\Database\Schema\ColumnDefinition  $definition
     * @return \AIMuseVendor\Illuminate\Database\Schema\ColumnDefinition
     */
