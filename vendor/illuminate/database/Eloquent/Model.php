...
namespace AIMuseVendor\Illuminate\Database\Eloquent;

use ArrayAccess;
use AIMuseVendor\Illuminate\Contracts\Broadcasting\HasBroadcastChannel;
use AIMuseVendor\Illuminate\Contracts\Queue\QueueableCollection;
use AIMuseVendor\Illuminate\Contracts\Queue\QueueableEntity;
use AIMuseVendor\Illuminate\Contracts\Routing\UrlRoutable;
use AIMuseVendor\Illuminate\Contracts\Support\Arrayable;
use AIMuseVendor\Illuminate\Contracts\Support\CanBeEscapedWhenCastToString;
use AIMuseVendor\Illuminate\Contracts\Support\Jsonable;
use AIMuseVendor\Illuminate\Database\ConnectionResolverInterface as Resolver;
use AIMuseVendor\Illuminate\Database\Eloquent\Collection as EloquentCollection;
use AIMuseVendor\Illuminate\Database\Eloquent\Relations\BelongsToMany;
use AIMuseVendor\Illuminate\Database\Eloquent\Relations\Concerns\AsPivot;
use AIMuseVendor\Illuminate\Database\Eloquent\Relations\HasManyThrough;
use AIMuseVendor\Illuminate\Database\Eloquent\Relations\Pivot;
use AIMuseVendor\Illuminate\Support\Arr;
use AIMuseVendor\Illuminate\Support\Collection as BaseCollection;
use AIMuseVendor\Illuminate\Support\Str;
use AIMuseVendor\Illuminate\Support\Traits\ForwardsCalls;
...
abstract class Model implements Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
     ...
     *
     * @var \AIMuseVendor\Illuminate\Database\ConnectionResolverInterface
     */
     ...
     *
     * @var \AIMuseVendor\Illuminate\Contracts\Events\Dispatcher
     */
     ...
     * @return $this
     *
     * @throws \AIMuseVendor\Illuminate\Database\Eloquent\MassAssignmentException
     */
     ...
     *
     * @param  string|null  $connection
     * @return \AIMuseVendor\Illuminate\Database\Eloquent\Builder
     */
     ...
     *
     * @return \AIMuseVendor\Illuminate\Database\Query\Builder
     */
     ...
     * @return \AIMuseVendor\Illuminate\Database\Eloquent\Collection|static[]
     */
     ...
     *
     * @param  \AIMuseVendor\Illuminate\Database\Eloquent\Builder  $query
     * @return bool
     */
     ...
     *
     * @param  \AIMuseVendor\Illuminate\Support\Collection|array|int|string  $ids
     * @return int
     */
     ...
     *
     * @return \AIMuseVendor\Illuminate\Database\Eloquent\Builder|static
     */
     ...
     *
     * @param  \AIMuseVendor\Illuminate\Database\Eloquent\Builder  $builder
     * @return \AIMuseVendor\Illuminate\Database\Eloquent\Builder
     */
     ...
     *
     * @param  \AIMuseVendor\Illuminate\Database\Eloquent\Scope|string  $scope
     * @return \AIMuseVendor\Illuminate\Database\Eloquent\Builder
     */
     ...
     *
     * @param  array  $models
     * @return \AIMuseVendor\Illuminate\Database\Eloquent\Collection
     */
     ...
     *
     * @param  \AIMuseVendor\Illuminate\Database\Eloquent\Model  $parent
     * @param  array  $attributes
     * @param  string  $table
     * @param  bool  $exists
     * @param  string|null  $using
     * @return \AIMuseVendor\Illuminate\Database\Eloquent\Relations\Pivot
     */
     ...
     * @return string
     *
     * @throws \AIMuseVendor\Illuminate\Database\Eloquent\JsonEncodingException
     */
     ...
     *
     * @param  \AIMuseVendor\Illuminate\Database\Eloquent\Model|null  $model
     * @return bool
     */
     ...
     *
     * @return \AIMuseVendor\Illuminate\Database\Connection
     */
     ...
     *
     * @return \AIMuseVendor\Illuminate\Database\ConnectionResolverInterface
     */
     ...
     *
     * @param  \AIMuseVendor\Illuminate\Database\ConnectionResolverInterface  $resolver
     * @return void
     */
     ...
     * @return \AIMuseVendor\Illuminate\Database\Eloquent\Model|null
     */
     ...
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \AIMuseVendor\Illuminate\Database\Eloquent\Relations\Relation
     */
     ...
     * Retrieve the model for a bound value.
     *
     * @param  \AIMuseVendor\Illuminate\Database\Eloquent\Model|Illuminate\Database\Eloquent\Relations\Relation  $query
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \AIMuseVendor\Illuminate\Database\Eloquent\Relations\Relation
     */
