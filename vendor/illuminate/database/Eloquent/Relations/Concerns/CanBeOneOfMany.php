...
namespace AIMuseVendor\Illuminate\Database\Eloquent\Relations\Concerns;
...
trait CanBeOneOfMany
{
     ...
     *
     * @var \AIMuseVendor\Illuminate\Database\Eloquent\Builder|null
     */
     ...
     *
     * @param  \AIMuseVendor\Illuminate\Database\Eloquent\Builder  $parent
     * @param  \AIMuseVendor\Illuminate\Database\Eloquent\Builder  $subQuery
     * @param  string  $on
     * @return void
     */
     ...
     *
     * @return \AIMuseVendor\Illuminate\Database\Eloquent\Builder|void
     */
