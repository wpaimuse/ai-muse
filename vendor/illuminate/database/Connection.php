...
use AIMuseVendor\Illuminate\Database\Events\QueryExecuted;
use AIMuseVendor\Illuminate\Database\Events\StatementPrepared;
use AIMuseVendor\Illuminate\Database\Events\TransactionBeginning;
use AIMuseVendor\Illuminate\Database\Events\TransactionCommitted;
use AIMuseVendor\Illuminate\Database\Events\TransactionRolledBack;
use AIMuseVendor\Illuminate\Database\Query\Builder as QueryBuilder;
use AIMuseVendor\Illuminate\Database\Query\Expression;
use AIMuseVendor\Illuminate\Database\Query\Grammars\Grammar as QueryGrammar;
use AIMuseVendor\Illuminate\Database\Query\Processors\Processor;
use AIMuseVendor\Illuminate\Database\Schema\Builder as SchemaBuilder;
...
class Connection implements ConnectionInterface
{
     ...
     *
     * @var \AIMuseVendor\Illuminate\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @var \AIMuseVendor\Illuminate\Database\DatabaseTransactionsManager
     */
     ...
     *
     * @return \AIMuseVendor\Illuminate\Database\Schema\Grammars\Grammar
     */
     ...
     * @return mixed
     *
     * @throws \AIMuseVendor\Illuminate\Database\QueryException
     */
     ...
     *
     * @param  \AIMuseVendor\Illuminate\Database\QueryException  $e
     * @param  string  $query
     * @param  array  $bindings
     * @param  \Closure  $callback
     * @return mixed
     ...
     *
     * @param  \AIMuseVendor\Illuminate\Database\Query\Grammars\Grammar  $grammar
     * @return $this
     */
     ...
     *
     * @param  \AIMuseVendor\Illuminate\Database\Schema\Grammars\Grammar  $grammar
     * @return $this
     */
     ...
     *
     * @param  \AIMuseVendor\Illuminate\Database\Query\Processors\Processor  $processor
     * @return $this
     */
     ...
     *
     * @param  \AIMuseVendor\Illuminate\Contracts\Events\Dispatcher  $events
     * @return $this
     */
     ...
     *
     * @param  \AIMuseVendor\Illuminate\Database\DatabaseTransactionsManager  $manager
     * @return $this
     */
