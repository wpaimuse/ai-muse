...
namespace AIMuseVendor\Illuminate\Events;

use Closure;
use Exception;
use AIMuseVendor\Illuminate\Container\Container;
use AIMuseVendor\Illuminate\Contracts\Broadcasting\Factory as BroadcastFactory;
use AIMuseVendor\Illuminate\Contracts\Broadcasting\ShouldBroadcast;
...
use AIMuseVendor\Illuminate\Contracts\Queue\ShouldBeEncrypted;
use AIMuseVendor\Illuminate\Contracts\Queue\ShouldQueue;
...
class Dispatcher implements DispatcherContract
{
     ...
     *
     * @param  \AIMuseVendor\Illuminate\Contracts\Broadcasting\ShouldBroadcast  $event
     * @return void
     */
