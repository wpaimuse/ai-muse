...
use AIMuseVendor\Illuminate\Http\Exceptions\HttpResponseException;
use AIMuseVendor\Symfony\Component\HttpFoundation\HeaderBag;
use Throwable;
...
trait ResponseTrait
{
     ...
     *
     * @param  \AIMuseVendor\Symfony\Component\HttpFoundation\HeaderBag|array  $headers
     * @return $this
     */
     ...
     *
     * @param  \AIMuseVendor\Symfony\Component\HttpFoundation\Cookie|mixed  $cookie
     * @return $this
     */
     ...
     * @return void
     *
     * @throws \AIMuseVendor\Illuminate\Http\Exceptions\HttpResponseException
     */
