...
use AIMuseVendor\GuzzleHttp\Exception\TransferException;
use AIMuseVendor\GuzzleHttp\HandlerStack;
use AIMuseVendor\Illuminate\Http\Client\Events\ConnectionFailed;
use AIMuseVendor\Illuminate\Http\Client\Events\RequestSending;
use AIMuseVendor\Illuminate\Http\Client\Events\ResponseReceived;
...
use AIMuseVendor\Illuminate\Support\Traits\Conditionable;
...
class PendingRequest
{
     ...
     *
     * @var \AIMuseVendor\Illuminate\Http\Client\Factory|null
     */
    protected $factory;
     ...
     *
     * @var \AIMuseVendor\GuzzleHttp\Client
     */
    protected $client;
     ...
     *
     * \AIMuseVendor\GuzzleHttp\TransferStats
     */
     ...
     *
     * @var \AIMuseVendor\Illuminate\Support\Collection|null
     */
     ...
     *
     * @var \AIMuseVendor\GuzzleHttp\Promise\PromiseInterface
     */
    protected $promise;
     ...
     *
     * @var \AIMuseVendor\Illuminate\Http\Client\Request|null
     */
    protected $request;
     ...
     *
     * @param  \AIMuseVendor\Illuminate\Http\Client\Factory|null  $factory
     * @return void
     */
     ...
     * @return \AIMuseVendor\Illuminate\Http\Client\Response
     */
     ...
     * @param  string  $url
     * @param  array  $options
     * @return \AIMuseVendor\Psr\Http\Message\MessageInterface|\AIMuseVendor\GuzzleHttp\Promise\PromiseInterface
     *
     * @throws \Exception
     */
     ...
     *
     * @return \AIMuseVendor\GuzzleHttp\Client
     */
     ...
     *
     * @param  \AIMuseVendor\GuzzleHttp\HandlerStack  $handlerStack
     * @return \AIMuseVendor\GuzzleHttp\Client
     */
     ...
     *
     * @return \AIMuseVendor\GuzzleHttp\HandlerStack
     */
     ...
     *
     * @return \AIMuseVendor\GuzzleHttp\Promise\PromiseInterface|null
     */
     ...
     *
     * @param  \AIMuseVendor\GuzzleHttp\Client  $client
     * @return $this
     */
