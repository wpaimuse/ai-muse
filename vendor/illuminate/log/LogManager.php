...
namespace AIMuseVendor\Illuminate\Log;

use Closure;
use AIMuseVendor\Illuminate\Support\Str;
use InvalidArgumentException;
use AIMuseVendor\Monolog\Formatter\LineFormatter;
use AIMuseVendor\Monolog\Handler\ErrorLogHandler;
use AIMuseVendor\Monolog\Handler\FingersCrossedHandler;
use AIMuseVendor\Monolog\Handler\FormattableHandlerInterface;
use AIMuseVendor\Monolog\Handler\HandlerInterface;
use AIMuseVendor\Monolog\Handler\RotatingFileHandler;
use AIMuseVendor\Monolog\Handler\SlackWebhookHandler;
use AIMuseVendor\Monolog\Handler\StreamHandler;
use AIMuseVendor\Monolog\Handler\SyslogHandler;
use AIMuseVendor\Monolog\Handler\WhatFailureGroupHandler;
use AIMuseVendor\Monolog\Logger as Monolog;
...
class LogManager implements LoggerInterface
{
     ...
     *
     * @param  array  $config
     * @return \AIMuseVendor\Psr\Log\LoggerInterface
     */
     ...
     *
     * @param  string  $name
     * @param  \AIMuseVendor\Illuminate\Log\Logger  $logger
     * @return \AIMuseVendor\Illuminate\Log\Logger
     */
     ...
     *
     * @throws \InvalidArgumentException
     * @throws \AIMuseVendor\Illuminate\Contracts\Container\BindingResolutionException
     */
     ...
     *
     * @param  \AIMuseVendor\Monolog\Handler\HandlerInterface  $handler
     * @param  array  $config
     * @return \AIMuseVendor\Monolog\Handler\HandlerInterface
     */
     ...
     *
     * @return \AIMuseVendor\Monolog\Formatter\FormatterInterface
     */
