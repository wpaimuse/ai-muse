...
use AIMuseVendor\Illuminate\Contracts\Foundation\Application;
use AIMuseVendor\Illuminate\Contracts\View\Factory;
use AIMuseVendor\Illuminate\Filesystem\Filesystem;
use AIMuseVendor\Illuminate\Support\Str;
use AIMuseVendor\Illuminate\View\AnonymousComponent;
use AIMuseVendor\Illuminate\View\DynamicComponent;
use AIMuseVendor\Illuminate\View\ViewFinderInterface;
...
class ComponentTagCompiler
{
     ...
     *
     * @var \AIMuseVendor\Illuminate\View\Compilers\BladeCompiler
     */
    protected $blade;
     ...
     * @param  \AIMuseVendor\Illuminate\View\Compilers\BladeCompiler|null  $blade
     * @return void
     */
        ...
        return collect($attributes)
                ->map(function (string $value, string $attribute) use ($escapeBound) {
                    return $escapeBound && isset($this->boundAttributes[$attribute]) && $value !== 'true' && ! is_numeric($value)
                                ? "'{$attribute}' => \AIMuseVendor\Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute({$value})"
                                : "'{$attribute}' => {$value}";
                })
                ->implode(',');
    }
