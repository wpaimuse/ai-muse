...
namespace AIMuseVendor\Illuminate\View\Compilers;

use AIMuseVendor\Illuminate\Container\Container;
use AIMuseVendor\Illuminate\Contracts\Support\Htmlable;
use AIMuseVendor\Illuminate\Contracts\View\Factory as ViewFactory;
use AIMuseVendor\Illuminate\Contracts\View\View;
...
use AIMuseVendor\Illuminate\View\Component;
...
class BladeCompiler extends Compiler implements CompilerInterface
{
     ...
     *
     * @param  \AIMuseVendor\Illuminate\View\Component  $component
     * @return string
     */
    ...
    public function if($name, callable $callback)
    {
        ...
        $this->directive($name, function ($expression) use ($name) {
            return $expression !== ''
                    ? "<?php if (\AIMuseVendor\AIMuseVendor\AIMuseVendor\Illuminate\Support\Facades\Blade::check('{$name}', {$expression})): ?>"
                    : "<?php if (\AIMuseVendor\AIMuseVendor\AIMuseVendor\Illuminate\Support\Facades\Blade::check('{$name}')): ?>";
        });
        ...
        $this->directive('else'.$name, function ($expression) use ($name) {
            return $expression !== ''
                ? "<?php elseif (\AIMuseVendor\AIMuseVendor\AIMuseVendor\Illuminate\Support\Facades\Blade::check('{$name}', {$expression})): ?>"
                : "<?php elseif (\AIMuseVendor\AIMuseVendor\AIMuseVendor\Illuminate\Support\Facades\Blade::check('{$name}')): ?>";
        });
    ...
    public function aliasInclude($path, $alias = null)
    {
        ...
        $this->directive($alias, function ($expression) use ($path) {
            ...
            return "<?php echo \$__env->make('{$path}', {$expression}, \AIMuseVendor\Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>";
        });
    }
