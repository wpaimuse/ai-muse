...
namespace AIMuseVendor\Symfony\Component\HttpKernel\EventListener;
...
use AIMuseVendor\Symfony\Component\HttpFoundation\Cookie;
use AIMuseVendor\Symfony\Component\HttpFoundation\Session\Session;
use AIMuseVendor\Symfony\Component\HttpFoundation\Session\SessionInterface;
use AIMuseVendor\Symfony\Component\HttpFoundation\Session\SessionUtils;
...
use AIMuseVendor\Symfony\Component\HttpKernel\Exception\UnexpectedSessionUsageException;
use AIMuseVendor\Symfony\Component\HttpKernel\KernelEvents;
        ...
        if ($session->isStarted()) {
            ...
            if ($sessionUseCookies) {
                ...
                if ($requestSessionCookieId && $isSessionEmpty) {
                    ...
                    // which happens in \AIMuseVendor\Symfony\Component\HttpFoundation\Session\Storage\Handler\AbstractSessionHandler::destroy
