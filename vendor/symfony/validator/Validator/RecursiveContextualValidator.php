...
namespace AIMuseVendor\Symfony\Component\Validator\Validator;
...
use AIMuseVendor\Symfony\Component\Validator\Constraints\Existence;
...
use AIMuseVendor\Symfony\Component\Validator\ConstraintValidatorFactoryInterface;
...
use AIMuseVendor\Symfony\Component\Validator\Exception\RuntimeException;
use AIMuseVendor\Symfony\Component\Validator\Exception\UnexpectedValueException;
use AIMuseVendor\Symfony\Component\Validator\Exception\UnsupportedMetadataException;
use AIMuseVendor\Symfony\Component\Validator\Exception\ValidatorException;
use AIMuseVendor\Symfony\Component\Validator\Mapping\CascadingStrategy;
use AIMuseVendor\Symfony\Component\Validator\Mapping\ClassMetadataInterface;
use AIMuseVendor\Symfony\Component\Validator\Mapping\Factory\MetadataFactoryInterface;
use AIMuseVendor\Symfony\Component\Validator\Mapping\GenericMetadata;
use AIMuseVendor\Symfony\Component\Validator\Mapping\GetterMetadata;
...
use AIMuseVendor\Symfony\Component\Validator\Mapping\TraversalStrategy;
use AIMuseVendor\Symfony\Component\Validator\ObjectInitializerInterface;
...
class RecursiveContextualValidator implements ContextualValidatorInterface
{
    ...
    public function validateProperty(object $object, string $propertyName, $groups = null)
    {
        ...
        if (!$classMetadata instanceof ClassMetadataInterface) {
            throw new ValidatorException(sprintf('The metadata factory should return instances of "\AIMuseVendor\Symfony\Component\Validator\Mapping\ClassMetadataInterface", got: "%s".', get_debug_type($classMetadata)));
        }
        ...
        foreach ($groups as $key => $group) {
            ...
            if (Constraint::DEFAULT_GROUP === $group) {
                if ($metadata->hasGroupSequence()) {
                    ...
                    // object
                    /* @var \AIMuseVendor\Symfony\Component\Validator\GroupSequenceProviderInterface $object */
