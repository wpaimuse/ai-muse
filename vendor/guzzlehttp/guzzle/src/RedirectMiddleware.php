...
use AIMuseVendor\GuzzleHttp\Exception\BadResponseException;
use AIMuseVendor\GuzzleHttp\Exception\TooManyRedirectsException;
 ...
 * {@see \AIMuseVendor\GuzzleHttp\Middleware::redirect()}.
 *
 * @final
 */
